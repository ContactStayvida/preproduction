...
public class LookupService {
    ...
    public List<Feature> getFeatures() { return repo.getFeatures(); }

    public List<Amenity> getAmenities() { return repo.getAmenities(); }

    public List<Tag> getTags() { return repo.getTags(); }
}
