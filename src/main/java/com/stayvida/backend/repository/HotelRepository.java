...
public class HotelRepository {
    ...
    public List<Hotel> getTop3HotelsByRating() {
        String sql = "SELECT h.*, (SELECT MIN(r.price)     FROM rooms r WHERE r.hotel_ID = h.hotel_ID) AS lowest_price  FROM hotels h WHERE h.status = 'Verified' ORDER BY h.rating DESC LIMIT 3 ";
